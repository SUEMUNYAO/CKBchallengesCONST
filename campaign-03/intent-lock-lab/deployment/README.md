...
offckb deploy --network devnet --target <contract-binary-path> --output /home/core/Desktop/CKB/CKBchallengesCONST/campaign-03/intent-lock-lab/deployment
```
...
```bash
# Deploy to testnet
offckb deploy --network testnet --target <contract-binary-path> --output /home/core/Desktop/CKB/CKBchallengesCONST/campaign-03/intent-lock-lab/deployment
```
