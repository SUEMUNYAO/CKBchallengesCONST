...
// @ts-ignore - @ckb-lumos/lumos is a transitive dependency of @spore-sdk/core
...
/**
 * Create a CKB Default Lock (Secp256k1Blake160 Sign-all) Wallet
 * from a private key and a SporeConfig, providing lock/address,
 * and functions to sign message/transaction and send on-chain.
 */
